...
class SurveillanceBot():
    ...
    def open_activate_command_callback(self, update: Update, context: CallbackContext):
    ...
    def admin_pause_surveillance_command_callback(self, update: Update, context: CallbackContext):
        pass

    def mod_show_users_with_roles_command_callback(self, update: Update, context: CallbackContext):
    ...
    def admin_create_token_command_callback(self, update: Update, context: CallbackContext):
    ...
    def alert(self):
        ...
        for user in self.users:
            self._send_text_msg(user, 'Movement detected!')
        
    def send_surveillance_video(self, video):
        if not video:
            return
    ...
    def _is_authorized(self, chat_id, command_authorization_level):
        ''' Check if chat_id is authorized for command '''
    ...
    def _send_text_msg(self, chat_id, text):
